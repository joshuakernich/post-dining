...
var layers = [
  {
    title:"Select your <b>Bun</b>",
    subtitle:"The breads and cereals food group provides energy and fibre",
    short: "Bun",
    list:[
    ...
    title:"Select your <b>Patty</b>",
    subtitle:"Meats & alternatives provide protein for growth & strength",
    short: "Patty",
    list:[
    ...
    subtitle:'Vegetables provide vitamins and minerals for metabolism and immunity',
    short: "Veg",
    list:[
    ...
    title:"Select your <b>Cheese</b>",
    subtitle:'Dairy & alternatives provide calcium for healthy bones & teeth',
    short: "Cheese",
    list:[
    ...
    title:"Select your <b>Topping</b>",
    subtitle:'Healthy fats support brain health and provide energy',
    short: "Topping",
    list:[
...
<p>Today, you are granted the privilege to build your own burger. However, you must choose wisely, as you only have 400 water dollars to spend on your selection of ingredients from each of the food groups.</p>\
